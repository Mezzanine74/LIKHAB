...
namespace LIKHAB._GenericRepository
{

    public class GenericRepository<TEntity, Tlog> : Loggable where TEntity : class, IId
                                                  where Tlog : class, ILog, new()
    {
        ...
        public OperationResult Add(TEntity entity)
        {
            ...
            if (entity.Validate().Success)
            {
                ...
                IRecordable recordable = (IRecordable)entity;

                if (recordable != null)
                {
                    recordable.Uniqueidentifier = Guid.NewGuid().ToString();
                    recordable.WhoCreated = this._currentUser;
                    recordable.WhenCreated = LocalTime.GetIstanbul();
                }
        ...
        public OperationResult Update(TEntity entity)
        {
            ...
            if (entity.Validate().Success)
            {
                ...
                if (recordable != null)
                {
                    IRecordable _entityRecordable = (IRecordable)_entity;

                    recordable.Uniqueidentifier = _entityRecordable.Uniqueidentifier;
                    recordable.WhoCreated = _entityRecordable.WhoCreated;
                    recordable.WhenCreated = _entityRecordable.WhenCreated;
                    recordable.WhoUpdated = this._currentUser;
                    recordable.WhenUpdated = LocalTime.GetIstanbul();
                }
                // ..........................preserve previous data 
        ...
        public OperationResult Remove(int Id)
        {
            ...
            if (recordable != null)
            {
                IRecordable _entRecordable = (IRecordable)_entity;

                recordable.Uniqueidentifier = _entRecordable.Uniqueidentifier;
                recordable.WhoCreated = _entRecordable.WhoCreated;
                recordable.WhenCreated = _entRecordable.WhenCreated;
                recordable.WhoUpdated = _entRecordable.WhoUpdated;
                recordable.WhenUpdated = _entRecordable.WhenUpdated;
                recordable.WhoDeleted = this._currentUser;
                recordable.WhenDeleted = LocalTime.GetIstanbul();
            }
